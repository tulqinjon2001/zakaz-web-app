...
const StoreSelection = () => {
  ...
  const fetchStores = async () => {
    try {
      ...
      const apiUrl = import.meta.env.VITE_API_URL || 'https://zakaz-backend-production.up.railway.app/api';
            ...
            <div className="card text-center py-8 space-y-4">
              ...
              {import.meta.env.DEV && (
                <p className="text-xs text-tg-hint mt-2">
                  API URL: {import.meta.env.VITE_API_URL || 'https://zakaz-backend-production.up.railway.app/api'}
                </p>
              )}
            </div>
          ) : stores.length === 0 ? (
